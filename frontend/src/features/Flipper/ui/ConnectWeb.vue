<template>
  <template v-if="type === 'item'">
    <q-item :disable="flipperStore.flags.disableNavigation" clickable @click="onClick">
  ...
  <template v-else>
    <q-btn outline color="white" icon="cable" label="Connect" :disabled="flipperStore.flags.disableNavigation"
      @click="onClick" />
  </template>
</template>
